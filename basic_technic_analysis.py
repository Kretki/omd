...
def number_of_values(laureates_list: list):
    """
...
def missings_statistics(laureates_list: list):
    """
...
def ids_analysis(laureates_list: list):
    """
...
def basic_laureates_analysis(laureates_list: list):
    """
